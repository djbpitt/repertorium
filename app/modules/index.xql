...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <h1><a href="http://repertorium.obdurodon.org" class="logo">&lt;rep&gt;</a>
        ...
        <p class="boilerplate">
            <span><strong>Maintained by:</strong> David J. Birnbaum (<a
                    ...
                    href="http://creativecommons.org/licenses/by-nc-sa/4.0/" style="outline: none;">
                    <img src="{concat($fqcontroller ,'resources/images/cc-by-nc-sa-80x15.png')}"
            ...
            <span>
                <strong>Last modified:</strong> {current-dateTime()}</span>
        </p>
        <hr />
        ...
        <ul>
            <li>
                <a href="browse-checkbox.php">Browse the collection</a>
            </li>
            <li>Search the collection <ul>
                    <li><a href="search.php">By location, full text of title, etc.</a></li>
                    <li><label for="searchTitlesFree">Case-insensitive substring search in text
                            title </label>
                        <input id="searchTitlesFree" type="text" size="25"
                            placeholder="press [enter] to search" /></li>
                </ul>
            </li>
            <li>Dendrogram overviews of the corpus (<a href="dendrogram-complete.xhtml"
                >complete</a>, <a href="dendrogram-ward.xhtml">Ward’s</a>, and <a
        ...
        <ul>
            <li><a href="fullBibl.php">Browse</a> the bibliography (<a
                    href="{concat($fqcontroller, 'aux/bib.xml')}"><img
                        src="{concat($fqcontroller, 'resources/images/xml.gif')}" alt="[XML]" /></a>)</li>
            <li>Search the bibliography (case-insensitive, full words only)<ul>
                    <li><label for="input">Any field </label>
                        <input id="input" type="text" size="25"
                            placeholder="press [enter] to search" /></li>
                    <li><label for="keyword">Keyword </label>
                        <input id="keyword" type="text" size="25"
                            placeholder="press [enter] to search" /></li>
                    <li><label for="surname">Surname </label>
                        <input id="surname" type="text" size="25"
                            placeholder="press [enter] to search" /></li>
                    <li><label for="pubPlace">Publication place</label>
                        <input id="pubPlace" type="text" size="25"
                            placeholder="press [enter] to search" /></li>
                </ul></li>
        </ul>
        ...
        <ul>
            ...
            <li><label for="searchFree">Case-insensitive substring search in full descriptions </label>
                <input id="searchFree" type="text" size="25" placeholder="press [enter] to search"
                 /></li>
            <li>Encoding guidelines and schema files<ul>
                    <li><a href="{concat($fqcontroller, 'resources/pdf/Bojadziev_Scripta_11.pdf')}">Guidelines to Repertorium Initiative XML
                            model for manuscript descriptions 
                            <img src="{concat($fqcontroller, 'resources/images/pdf.gif')}" alt="[pdf]"
                             /></a> (Andrej Bojadžiev, <cite>Scripta &amp; e-Scripta</cite> 10–11
                        (2012): 9–103)</li>
                    <li><a href="{concat($fqcontroller, 'encoding-policies-updates')}">Recent additions and changes to
                            encoding policies and guidelines</a></li>
                    <li>Schema: <a href="tei_ms_repertorium.odd">TEI ODD</a>, <a
                    ...
                    <li>Schematron: <a href="tei_ms_repertorium.sch">Schematron</a></li>
                </ul></li>
            <li>Authority files<ul>
                    <li><a href="titles_cyrillic.xhtml">Text titles in Bulgarian, English, and
                            Russian</a> (<a
                            href="http://obdurodon.org:8080/exist/rest/db/repertorium/aux/titles_cyrillic.xml"
                                ><img src="{concat($fqcontroller, 'resources/images/xml.gif')}" alt="[XML]" /></a>)</li>
                    <li><a href="{concat($fqcontroller, 'resources/pdf/hagio_ind.pdf')}">Standard English spelling of saints and other
                            hagiographic terms <img src="{concat($fqcontroller, 'resources/images/pdf.gif')}" alt="[pdf]" /></a></li>
                    <li><a href="genres.xml">XML table of general and specific genres for use in
            ...
            <li>Data dumps<ul class="three-column">
                    ...
                    <li><a href="list_of_authors_en.xhtml">Authors (of texts, authority
                        file)</a></li>
                    <li><a
            ...
            <li>Finding errors<ul>
                    ...
                    <li>Unicode issues: <a href="http://repertorium.obdurodon.org/pua-test.php"
                            >PUA</a> | <a
            ...
            <li>External resources <ul>
                    ...
                    <li><a href="http://repertorium.cl.bas.bg/descriptions/MSLIST.html"
        ...
        <ul class="two-column">
            ...
            <li><a href="http://xmlstar.sourceforge.net/">XMLStarlet</a> command-line XML
                utilities</li>
            <li><a href="https://www.jetbrains.com/phpstorm/">PhpStorm</a> web technologies editor
                and IDE</li>
            ...
            <li><a href="http://kodeks.uni-bamberg.de/aksl/schrift/BukyVede.htm">Bukyvede</a> Slavic
                Cyrillic font from <a href="http://www.maccampus.de/">MacCampus</a>
                (production)</li>
